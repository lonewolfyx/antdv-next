...
Antdv Next 致力于提供给程序员**愉悦**的开发体验。在开始之前，推荐先学习 [Vue](https://cn.vuejs.org/)，并正确安装和配置了 [Node.js](https://nodejs.org/zh-cn/) v20 或以上。

官方指南假设你已了解关于 HTML、CSS 和 JavaScript 的中级知识，并且已经完全掌握了 Vue 全家桶的正确开发方式。如果你刚开始学习前端或者 Vue，将 UI 框架作为你的第一步可能不是最好的主意。
...
按照以下步骤亲自体验 Antdv Next：

### 1. 创建一个 StackBlitz {#create-stackblitz}
...
### 2. 使用组件 {#use-antdv-next-component}

如果你在本地 Vue 项目中开发，请先安装 `antdv-next`。上面创建的 StackBlitz 已经包含该依赖。
...
在代码演示部分找到第一个例子，点击“显示代码”图标查看源码。你可以直接复制代码到 StackBlitz 中尝试并自行调整。
